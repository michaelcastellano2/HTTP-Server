...
public class HTTPConnection implements Runnable {
    ...
    private void processRequest() {
        try {
            HTTPRequest request = new HTTPRequest(socketInput);
            if (request.isValid()) {
	    ...
	    HTTPResponse response = new HTTPResponse(request, socketOutput);
	    System.out.println(client + ": Sending " + response.getStatusCode() + " response");
